        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title: const Text(
                  'Can I receive notifications for specific hive events'),
              onTap: () {},
            ),
            ListTile(
              leading: CircleAvatar(
              ...
              title: const Text(
                  'How do I troubleshoot connectivity issues between the device and app'),
              onTap: () {},
            ),
            ListTile(
              leading: CircleAvatar(
              ...
              title:
                  const Text('How can I track long-term trends in  data'),
              onTap: () {},
            ),
            Padding(
